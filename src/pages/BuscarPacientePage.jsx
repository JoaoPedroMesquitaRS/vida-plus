    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <header className="max-w-5xl mx-auto mb-8">
                <h1 className="text-2xl font-semibold text-gray-800">Iniciar Atendimento</h1>
                <p className="text-gray-600 mt-1">
                    Busque um paciente pelo filtro desejado e inicie o atendimento.
                </p>
            </header>
            ...
            <main className="max-w-5xl mx-auto bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                ...
                <div className="flex flex-col md:flex-row md:items-end gap-4 mb-6">
                    ...
                    <button 
                        ...
                        onClick={async () => {
                            await buscarPacientes(filtroSelecionado)
                        }}
                    >
                        Buscar
                    </button>
                        ...
                        <tbody className="divide-y divide-gray-100 bg-white">
                            {resultados.map((resultado) => (
                                <tr className="hover:bg-gray-50 transition" key={resultado.id}>
                                    ...
                                    <td className="px-6 py-3 text-gray-600">{new Date(resultado.dataNascimento).toLocaleDateString("pt-BR")}</td>
